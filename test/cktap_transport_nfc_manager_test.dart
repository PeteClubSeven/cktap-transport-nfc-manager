...
void main() {
  ...
  test('getPlatformVersion', () async {
    CktapTransportNfcManager cktapTransportNfcManagerPlugin = CktapTransportNfcManager();
    MockCktapTransportNfcManagerPlatform fakePlatform = MockCktapTransportNfcManagerPlatform();
